                ...
                <div class = 'col-12 col-md-4'>  
                    <div class='card mt-2' style='width: 22rem;'>                    
                        <div class='card-body text-center'>
                            ...
                            <img src='../assets/images/house2.jpeg' class='card-img' width='100' height='200' class='card-img-top' alt='casa'>
                            ...
                            <p class='card-text'><strong>id_user: </strong>{$property->id_user}</p>
